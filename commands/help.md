...
5. **CRITIQUE (round 1)** — Evaluate against 12 principles (P1-P12) with PASS/FAIL. Do NOT rewrite.
6. **REVISE (round 1)** — Address all critique items. Do not finalize yet.
7. **CRITIQUE (round 2)** — Re-evaluate against principles. Do NOT rewrite.
...
| critique | 3+ numbered items, no `<promise>` tag, 6+ principle evidence (P-refs + PASS/FAIL combined) | Fewer than 3 items, promise present, or insufficient principle evaluation |
